...
import type { PaginationOptions } from '@/lib/server/medplum-server'
...
export default function HybridPanelPage({
  viewType,
  panel,
  columns: allColumns,
  data,
  ...
  const [appointments, setAppointments] = useState<Appointment[]>(data.data)
  ...
  const allColumnsForViewType = allColumns
  ...
  const onLoadMore = useCallback(async () => {
    ...
    try {
      ...
      const result = await getAppointmentsPaginated(paginationOptions)

...
const getKeyHighlightClasses = (key: string, searchTerm: string, searchMode: 'key' | 'value' | 'both'): string => {
            ...
            {expanded && (
                <div className="space-y-1">
                    {items.map((item, index) => {
                        ...
                        const keyMatches = getKeyHighlightClasses(key.toString(), searchTerm || '', searchMode)
